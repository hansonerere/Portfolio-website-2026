...
export function DrawerMenu({ projects, activeProject, onProjectSelect, onHomeSelect }: DrawerMenuProps) {
    ...
    <div className="bg-[#0f0f0f] border-b border-[#212121] sticky top-0 z-50">
      <div className="px-6 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <span className="text-white text-lg font-['Red_Hat_Display'] leading-none">POD studio</span>
        </div>

        <Sheet open={isOpen} onOpenChange={setIsOpen}>
          <SheetTrigger asChild>
            <Button variant="ghost" size="sm" className="text-white hover:bg-[#212121]">
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 12h16M4 18h16" />
              </svg>
            </Button>
          </SheetTrigger>
          <SheetContent side="left" className="w-80 bg-[#0f0f0f] border-[#212121] p-0">
